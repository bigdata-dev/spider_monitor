...
<div class="theCenterBox" style="">
  ...
  <div class="loginTxt"><font color=#FF0000 >${message}</font></div>
    <div class="loginTxt">超人学院CRM <a style="font-size:12px;color:red;float:right;padding-right:10px" href="${pageContext.request.contextPath }/images/student_login_fail.jpg">登录失败，怎么办?</a></div>
